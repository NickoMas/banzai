    ...
    <section class="content-block content-contacts" id="contacts">
        ...
        <div class="mapouter">
            <div class="gmap_canvas">
                <iframe gesture="media"  allow="encrypted-media" allowfullscreen width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=minsk%20ubarevicha%2074&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
...
<style>
    ...
    .content-contacts__wrapper .contacts-line {
        padding-bottom: 20px;
    }
