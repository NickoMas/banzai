<template>
  <div class="head-nav-contacts head-nav-blocks">
    ...
    <a class="head-nav-brand-link" href="/hero">
      ...
      <img
        v-if="isActiveHero && isDesktop"
        class="head-nav-brand-link__desktop--hor"
        src="images/banzai_logo_hor.png"
        alt="banzai_logo"
        height="40"
      />
    ...
    <ul class="head-nav-contacts__line social">
      <li class="social-icon">
        <a target="_blank" href="https://vk.com/banzai_team">
          <i class="fa fa-vk"></i>
        </a>
      </li>
      <li class="social-icon">
        <a target="_blank" href="https://www.instagram.com/banzai_karate/">
          <i class="fa fa-instagram"></i>
        </a>
      </li>
      <li class="social-icon">
        <a target="_blank" href="https://www.youtube.com/channel/UC1IFLnA3X21JLUPxTrKEWRA">
          <i class="fa fa-youtube"></i>
        </a>
      </li>
      <li class="social-icon">
        <a target="_blank" href="https://www.facebook.com/banzaikarateteam/">
